...
! function(e) {
    ...
    var i = function(e) {
        ...
        return t.innerHTML = "<!--[if IE " + e + "]><i></i><![endif]-->", i = 1 === t.getElementsByTagName("i").length, document.body.appendChild(t), t.parentNode.removeChild(t), i
            ...
            init: function(e) {
                var i = e.initialPreview,
                    a = e.id;
                i.length > 0 && !M(i) && (i = i.split(e.initialPreviewDelimiter)), t.data[a] = {
                    content: i,
            ...
            get: function(i, a, r) {
                ...
                return r = void 0 === r ? !0 : r, null === s.content[a] ? "" : (R(d) || R(d.frameClass) || (p += " " + d.frameClass), n = s.template.repl("{previewId}", c).repl("{frameClass}", p).repl("{fileindex}", o).repl("{content}", s.content[a]).repl("{footer}", t.footer(i, a, r)), s.tags.length && s.tags[a] && (n = _(n, s.tags[a])), R(d) || R(d.frameAttr) || (l = e(document.createElement("div")).html(n), l.find(".file-preview-initial").attr(d.frameAttr), n = l.html(), l.remove()), n)
            },
            add: function(i, a, r, n, l) {
                var o, s = e.extend(!0, {}, t.data[i]);
                return M(a) || (a = a.split(s.delimiter)), l ? (o = s.content.push(a) - 1, s.config[o] = r, s.tags[o] = n) : (o = a.length, s.content = a, s.config = r, s.tags = n), t.data[i] = s, o
            },
            set: function(i, a, r, n, l) {
                var o, s = e.extend(!0, {}, t.data[i]);
                if (M(a) || (a = a.split(s.delimiter)), l) {
            ...
            footer: function(e, i, a) {
                var r = t.data[e];
                if (a = void 0 === a ? !0 : a, 0 === r.config.length || R(r.config[i])) return "";
                var n = r.config[i],
                    l = z("caption", n) ? n.caption : "",
                    o = z("width", n) ? n.width : "auto",
                    s = z("url", n) ? n.url : !1,
                    d = z("key", n) ? n.key : null,
                    c = s === !1 && a,
                    p = r.isDelete ? r.actions(!1, !0, c, s, d) : "",
                    u = r.footer.repl("{actions}", p);
        ...
        x = '<button type="button" class="kv-file-remove {removeClass}" title="{removeTitle}"{dataUrl}{dataKey}>{removeIcon}</button>\n',
        ...
        H = function(t, a) {
            var n = this;
            n.$element = e(t), n.validate() && (n.isPreviewable = r(), n.isIE9 = i(9), n.isIE10 = i(10), n.isPreviewable || n.isIE9 ? (n.init(a), n.listen()) : n.$element.removeClass("file-loading"))
        };
    H.prototype = {
        constructor: H,
        validate: function() {
        ...
        raise: function(i, t) {
            var a = this,
                r = e.Event(i);
            if (void 0 !== t ? a.$element.trigger(r, t) : a.$element.trigger(r), !r.result) return r.result;
            switch (i) {
        ...
        getLayoutTemplate: function(e) {
            var i = this,
                t = z(e, i.layoutTemplates) ? i.layoutTemplates[e] : U[e];
            return R(i.customLayoutTags) ? t : _(t, i.customLayoutTags)
        },
        getPreviewTemplate: function(e) {
            var i = this,
                t = z(e, i.previewTemplates) ? i.previewTemplates[e] : j[e];
        ...
        listen: function() {
            ...
            t.on("change", e.proxy(i.change, i)), e(window).on("resize", function() {
                ...
                var a, r = e(this),
                    n = !r.hasClass("disabled") && R(r.attr("disabled"));
        ...
        abort: function(i) {
            var t, a = this;
            return a.ajaxAborted && "object" == typeof a.ajaxAborted && void 0 !== a.ajaxAborted.message ? (t = e.extend(a.getOutData(), i), t.abortData = a.ajaxAborted.data || {}, t.abortMessage = a.ajaxAborted.message, a.showUploadError(a.ajaxAborted.message, t, "filecustomerror"), !0) : !1
        },
        noFilesError: function(e) {
            var i = this,
                ...
                r = i.$errorContainer;
            r.html(a), i.isError = !0, i.updateFileDetails(0), r.fadeIn(800), i.raise("fileerror", [e]), i.clearFileInput(), o(i.$container, "has-error")
        },
        ...
        upload: function() {
            var i, t, a, r = this,
                ...
                l = {}, o = !e.isEmptyObject(r.getExtraData());
        ...
        refresh: function(i) {
            ...
            r.off(), a.init(n), t = a.$container.find(".file-drop-zone"), t.off("dragenter dragover dragleave drop"), e(document).off("dragenter dragover drop"), a.listen(), a.setFileDropZoneTitle()
        },
        initDragDrop: function() {
            var i = this,
                t = i.$container.find(".file-drop-zone");
            t.off("dragenter dragover dragleave drop"), e(document).off("dragenter dragover drop"), t.on("dragenter dragover", function(t) {
                var a = e.inArray("Files", t.originalEvent.dataTransfer.types) > -1;
                return t.stopPropagation(), t.preventDefault(), i.isDisabled || !a ? (t.originalEvent.dataTransfer.effectAllowed = "none", void(t.originalEvent.dataTransfer.dropEffect = "none")) : void o(e(this), "highlighted")
                ...
                t.preventDefault(), i.isDisabled || R(t.originalEvent.dataTransfer.files) || (i.change(t, "dragdrop"), e(this).removeClass("highlighted"))
        ...
        initFileActions: function() {
            ...
            i.$preview.find(".kv-file-remove").each(function() {
                ...
                n.off("click").on("click", function() {
                    i.cleanMemory(l), l.fadeOut("slow", function() {
                        i.filestack[o] = void 0, i.clearObjects(l), l.remove();
                        var e = i.getFileStack(),
                            n = e.length,
                            s = t.count(i.id);
                        i.clearFileInput(), 0 === n && 0 === s ? i.reset() : (a = s + n, r = a > 1 ? i.getMsgSelected(a) : e[0].name, i.setCaption(r))
                    })
                })
        ...
        renderFileFooter: function(e, i) {
            ...
            return r.isUploadable ? (t = l.repl("{actions}", r.renderFileActions(!0, !0, !1, !1, !1)), a = t.repl("{caption}", e).repl("{width}", i).repl("{indicator}", n.indicatorNew).repl("{indicatorTitle}", n.indicatorNewTitle)) : a = l.repl("{actions}", "").repl("{caption}", e).repl("{width}", i).repl("{indicator}", "").repl("{indicatorTitle}", ""), a = _(a, r.previewThumbTags)
        },
        renderFileActions: function(e, i, t, a, r) {
            ...
            var n = this,
                ...
                p = n.otherActionButtons.repl("{dataKey}", o),
                u = n.fileActionSettings,
                f = t ? u.removeClass + " disabled" : u.removeClass;
            return s = s.repl("{removeClass}", f).repl("{removeIcon}", u.removeIcon).repl("{removeTitle}", u.removeTitle).repl("{dataUrl}", l).repl("{dataKey}", o), e && (d = n.getLayoutTemplate("actionUpload").repl("{uploadClass}", u.uploadClass).repl("{uploadIcon}", u.uploadIcon).repl("{uploadTitle}", u.uploadTitle)), c.repl("{delete}", s).repl("{upload}", d).repl("{other}", p)
        },
        setThumbStatus: function(e, i) {
            ...
            e.removeClass("file-preview-success file-preview-error file-preview-loading"), l.html(o[a]), l.attr("title", o[r]), e.addClass(n)
        },
        ...
        initPreview: function(e) {
            var i, a = this,
                r = a.initialCaption || "";
            return t.count(a.id) ? (i = t.out(a.id), r = e && a.initialCaption ? a.initialCaption : i.caption, a.$preview.html(i.content), a.setCaption(r), void(R(i.content) || a.$container.removeClass("file-input-new"))) : (a.clearPreview(), void(e ? a.setCaption(r) : a.initCaption()))
        },
        initPreviewDeletes: function() {
            var i = this,
                a = i.deleteExtraData || {}, r = function() {
                    0 === i.$preview.find(".kv-file-remove").length && (i.reset(), i.initialCaption = "")
                };
            i.$preview.find(".kv-file-remove").each(function() {
                var n = e(this),
                    l = n.data("url") || i.deleteUrl,
                    s = n.data("key");
                if (!R(l) && void 0 !== s) {
                    var d, c, p, u, f = n.closest(".file-preview-frame"),
                        v = t.data[i.id],
                        h = f.data("fileindex");
                    h = parseInt(h.replace("init_", "")), p = R(v.config) && R(v.config[h]) ? null : v.config[h], u = R(p) || R(p.extra) ? a : p.extra, "function" == typeof u && (u = u()), c = {
                        ...
                        beforeSend: function(e) {
                            i.ajaxAborted = !1, i.raise("filepredelete", [s, e, u]), i.ajaxAborted ? e.abort() : (o(f, "file-uploading"), o(n, "disabled"))
                        },
                        success: function(e, a, l) {
                            var o, d;
                            return R(e) || R(e.error) ? (t.unset(i.id, h), o = t.count(i.id), d = o > 0 ? i.getMsgSelected(o) : "", i.raise("filedeleted", [s, l, u]), i.setCaption(d), f.removeClass("file-uploading").addClass("file-deleted"), void f.fadeOut("slow", function() {
                                i.clearObjects(f), f.remove(), r(), o || 0 !== i.getFileStack().length || (i.setCaption(""), i.reset())
                            })) : (c.jqXHR = l, c.response = e, i.showError(e.error, c, "filedeleteerror"), f.removeClass("file-uploading"), n.removeClass("disabled"), void r())
                        },
                        error: function(e, t, a) {
                            var n = i.parseError(e, a);
                            c.jqXHR = e, c.response = {}, i.showError(n, c, "filedeleteerror"), f.removeClass("file-uploading"), r()
                        }
                    }, i.ajaxDeleteSettings), n.off("click").on("click", function() {
                        e.ajax(d)
                    })
                }
            })
        ...
        clearFileInput: function() {
            var i, t, a, r = this,
                n = r.$element;
            R(n.val()) || (r.isIE9 || r.isIE10 ? (i = n.closest("form"), t = e(document.createElement("form")), a = e(document.createElement("div")), n.before(a), i.length ? i.after(t) : a.after(t), t.append(n).trigger("reset"), a.before(n).remove(), t.remove()) : n.val(""), r.fileInputCleared = !0)
        },
        ...
        clear: function() {
            var i, a = this;
            a.$btnUpload.removeAttr("disabled"), a.getThumbs().find("video,audio,img").each(function() {
                a.cleanMemory(e(this))
            }), a.resetUpload(), a.filestack = [], a.clearFileInput(), a.resetErrors(!0), a.raise("fileclear"), !a.overwriteInitial && t.count(a.id) ? (a.showFileIcon(), a.resetPreview(), a.setEllipsis(), a.initPreviewDeletes(), a.$container.removeClass("file-input-new")) : (a.getThumbs().each(function() {
        ...
        initUploadSuccess: function(i, a, r) {
            ...
            "object" != typeof i || e.isEmptyObject(i) || void 0 !== i.initialPreview && i.initialPreview.length > 0 && (u.hasInitData = !0, d = i.initialPreview || [], c = i.initialPreviewConfig || [], p = i.initialPreviewThumbTags || [], n = void 0 === i.append || i.append ? !0 : !1, u.overwriteInitial = !1, void 0 === a || r ? r ? (u.uploadCache.content.push(d[0]), u.uploadCache.config.push(c[0]), u.uploadCache.tags.push(p[0]), u.uploadCache.append = n) : (t.set(u.id, d, c, p, n), u.initPreview(), u.initPreviewDeletes()) : (o = t.add(u.id, d, c[0], p[0], n), l = t.get(u.id, o, !1), s = e(l).hide(), a.after(s).fadeOut("slow", function() {
        ...
        initSuccessThumbs: function() {
            ...
            i.getThumbs(".file-preview-success").each(function() {
                ...
                a.removeAttr("disabled").off("click").on("click", function() {
        ...
        uploadSingle: function(i, a, r) {
            var n, l, s, d, c, p, u, f, v, h = this,
                m = h.getFileStack().length,
                g = new FormData,
                w = h.previewInitId + "-" + i,
                b = e("#" + w + ":not(.file-preview-initial)"),
                C = b.find(".kv-file-upload"),
                x = b.find(".kv-file-remove"),
                y = h.filestack.length > 0 || !e.isEmptyObject(h.uploadExtraData),
                T = {
                    id: w,
                    index: i
                };
            h.formdata = g, 0 === m || !y || C.hasClass("disabled") || h.abort(T) || (s = function() {
                var e = h.getThumbs(".file-uploading");
                e.length > 0 || h.fileBatchCompleted || (h.fileBatchCompleted = !0, setTimeout(function() {
                    t.set(h.id, h.uploadCache.content, h.uploadCache.config, h.uploadCache.tags, h.uploadCache.append), h.hasInitData && (h.initPreview(), h.initPreviewDeletes()), h.setProgress(100), h.unlock(), h.clearFileInput(), h.raise("filebatchuploadcomplete", [h.filestack, h.getExtraData()])
                }, 100))
            }, d = function() {
                !r || 0 === m || h.uploadPercent >= 100 || (h.uploadCount += 1, l = 80 + Math.ceil(20 * h.uploadCount / m), h.uploadPercent = Math.max(l, h.uploadPercent), h.setProgress(h.uploadPercent), h.initPreviewDeletes())
            }, c = function() {
                C.removeAttr("disabled"), x.removeAttr("disabled"), b.removeClass("file-uploading")
            }, p = function(t) {
                n = h.getOutData(t), b.hasClass("file-preview-success") || (h.setThumbStatus(b, "Loading"), o(b, "file-uploading")), C.attr("disabled", !0), x.attr("disabled", !0), r || h.lock(), h.raise("filepreupload", [n, w, i]), T = e.extend(T, n), h.abort(T) && (t.abort(), h.setProgress(100))
            }, u = function(t, a, l) {
                n = h.getOutData(l, t), T = e.extend(T, n), setTimeout(function() {
                    R(t) || R(t.error) ? (h.setThumbStatus(b, "Success"), C.hide(), h.filestack[i] = void 0, h.raise("fileuploaded", [n, w, i]), h.initUploadSuccess(t, b, r), r || h.resetFileStack()) : (h.setThumbStatus(b, "Error"), h.showUploadError(t.error, T))
                }, 100)
            }, f = function() {
                setTimeout(function() {
                    d(), c(), r ? s() : h.unlock(!1), h.initSuccessThumbs()
                }, 100)
            }, v = function(t, n, l) {
                var o = h.parseError(t, l, r ? a[i].name : null);
                h.setThumbStatus(b, "Error"), T = e.extend(T, h.getOutData(t)), h.showUploadError(o, T)
            }, g.append(h.uploadFileAttr, a[i]), g.append("file_id", i), h.ajaxSubmit(p, u, f, v))
        },
        uploadBatch: function() {
            var i, t, a, r, n, l = this,
                ...
                p = {};
            l.formdata = new FormData, 0 !== d && c && !l.abort(p) && (i = function() {
                e.each(s, function(e) {
                ...
                l.showPreview && l.getThumbs().each(function() {
                    ...
                    i.hasClass("file-preview-success") || (l.setThumbStatus(i, "Loading"), o(i, "file-uploading")), t.attr("disabled", !0), a.attr("disabled", !0)
                }), l.raise("filebatchpreupload", [t]), l.abort(t) && i.abort()
            }, a = function(t, a, r) {
                var n = l.getOutData(r, t),
                    o = l.getThumbs(),
                    s = R(t.errorkeys) ? [] : t.errorkeys;
                R(t) || R(t.error) ? (l.raise("filebatchuploadsuccess", [n]), i(), l.showPreview ? (o.each(function() {
                    var i = e(this),
                        t = i.find(".kv-file-upload");
                    ...
                    return i.removeClass("file-uploading"), a.removeAttr("disabled"), t.removeAttr("disabled"), 0 === s.length ? void l.setThumbStatus(i, "Error") : void(-1 !== e.inArray(key, s) ? l.setThumbStatus(i, "Error") : (i.find(".kv-file-upload").hide(), l.setThumbStatus(i, "Success"), l.filestack[key] = void 0))
                }), l.initUploadSuccess(t)), l.showUploadError(t.error, n, "filebatchuploaderror"))
            }, r = function() {
                l.setProgress(100), l.unlock(), l.initSuccessThumbs(), l.raise("filebatchuploadcomplete", [l.filestack, l.getExtraData()]),
                l.clearFileInput()
            }, n = function(i, t, a) {
                ...
                R(s[e]) || l.formdata.append(l.uploadFileAttr, i)
        ...
        uploadExtraOnly: function() {
            ...
            r.formdata = new FormData, r.abort(n) || (e = function(e) {
                ...
                R(e) || R(e.error) ? (r.raise("filebatchuploadsuccess", [a]), r.clearFileInput(), r.initUploadSuccess(e)) : r.showUploadError(e.error, a, "filebatchuploaderror")
            }, t = function() {
        ...
        showUploadError: function(e, i, t) {
            ...
            var a = this,
                r = a.$errorContainer,
                n = t || "fileuploaderror";
            return 0 === r.find("ul").length ? r.html("<ul><li>" + e + "</li></ul>") : r.find("ul").append("<li>" + e + "</li>"), r.fadeIn(800), a.raise(n, [i]), o(a.$container, "has-error"), !0
        },
        showError: function(e, i, t) {
            ...
            var a = this,
                r = a.$errorContainer,
                n = t || "fileerror";
            return i = i || {}, i.reader = a.reader, r.html(e), r.fadeIn(800), a.raise(n, [i]), a.isUploadable || a.clearFileInput(), o(a.$container, "has-error"), a.$btnUpload.attr("disabled", !0), !0
        },
        ...
        parseFileType: function(e) {
            ...
            for (r = 0; r < A.length; r += 1)
                if (a = A[r], i = z(a, n.fileTypeSettings) ? n.fileTypeSettings[a] : O[a], t = i(e.type, e.name) ? a : "", !R(t)) return t;
            return "other"
        },
        previewDefault: function(i, t, a) {
            if (this.showPreview) {
                var r = this,
                    n = q.createObjectURL(i),
                    l = (e("#" + t), r.previewSettings.other),
                    o = r.renderFileFooter(i.name, l.width),
                    s = r.getPreviewTemplate("other"),
                    d = t.slice(t.lastIndexOf("-") + 1),
                    c = "";
                a === !0 && (c = " btn disabled", o += '<div class="file-other-error text-danger"><i class="glyphicon glyphicon-exclamation-sign"></i></div>'), r.$preview.append("\n" + s.repl("{previewId}", t).repl("{frameClass}", c).repl("{fileindex}", d).repl("{caption}", r.slug(i.name)).repl("{width}", l.width).repl("{height}", l.height).repl("{type}", i.type).repl("{data}", n).repl("{footer}", o))
            }
        },
        previewFile: function(e, i, t, a) {
            if (this.showPreview) {
                var r, n, l, o, s = this,
                    ...
                    v = z(d, s.previewSettings) ? s.previewSettings[d] : L[d],
        ...
        readFiles: function(i) {
            function t(e) {
                if (R(r.attr("multiple")) && (u = 1), e >= u) return a.isUploadable && a.filestack.length > 0 ? a.raise("filebatchselected", [a.getFileStack()]) : a.raise("filebatchselected", [i]), o.removeClass("loading"), void s.html("");
                var m, g, w, b, C, x, y = v + e,
                    T = p + "-" + y,
                    E = i[e],
                    k = a.slug(E.name),
                    F = (E.size || 0) / 1e3,
                    $ = "",
                    D = q.createObjectURL(E),
                    P = 0,
                    I = a.allowedFileTypes,
                    S = R(I) ? "" : I.join(", "),
                    U = a.allowedFileExtensions,
                    j = R(U) ? "" : U.join(", ");
                if (R(U) || ($ = new RegExp("\\.(" + U.join("|") + ")$", "i")), F = F.toFixed(2), a.maxFileSize > 0 && F > a.maxFileSize) return b = a.msgSizeTooLarge.repl("{name}", k).repl("{size}", F).repl("{maxSize}", a.maxFileSize), void(a.isError = h(b, E, T, e));
                if (!R(I) && M(I)) {
                    for (w = 0; w < I.length; w += 1) C = I[w], g = f[C], x = void 0 !== g && g(E.type, k), P += R(x) ? 0 : x.length;
                    if (0 === P) return b = a.msgInvalidFileType.repl("{name}", k).repl("{types}", S), void(a.isError = h(b, E, T, e))
                }
                return 0 !== P || R(U) || !M(U) || R($) || (x = k.match($), P += R(x) ? 0 : x.length, 0 !== P) ? a.showPreview ? (n.length > 0 && void 0 !== FileReader ? (s.html(d.repl("{index}", e + 1).repl("{files}", u)), o.addClass("loading"), l.onerror = function(e) {
                    a.errorHandler(e, k)
                }, l.onload = function(e) {
                    a.previewFile(E, e, T, D), a.initFileActions()
                }, l.onloadend = function() {
                    b = c.repl("{index}", e + 1).repl("{files}", u).repl("{percent}", 50).repl("{name}", k), setTimeout(function() {
                        s.html(b), t(e + 1), a.updateFileDetails(u)
                    }, 100), a.raise("fileloaded", [E, T, e, l])
                }, l.onprogress = function(i) {
                    if (i.lengthComputable) {
                        var t = i.loaded / i.total * 100,
                            a = Math.ceil(t);
                        b = c.repl("{index}", e + 1).repl("{files}", u).repl("{percent}", a).repl("{name}", k), setTimeout(function() {
                            s.html(b)
                        }, 100)
                    }
                }, m = z("text", f) ? f.text : O.text, m(E.type, k) ? l.readAsText(E, a.textEncoding) : l.readAsArrayBuffer(E)) : (a.previewDefault(E, T), setTimeout(function() {
                    t(e + 1), a.updateFileDetails(u)
                }, 100), a.raise("fileloaded", [E, T, e, l])), void a.filestack.push(E)) : (a.filestack.push(E), setTimeout(t(e + 1), 100), void a.raise("fileloaded", [E, T, e, l])) : (b = a.msgInvalidFileExtension.repl("{name}", k).repl("{extensions}", j), void(a.isError = h(b, E, T, e)))
            }
        ...
        change: function(i) {
            var a = this,
                r = a.$element;
            if (!a.isUploadable && R(r.val()) && a.fileInputCleared) return void(a.fileInputCleared = !1);
            a.fileInputCleared = !1;
            var n, l, o, s, d = a.$preview,
                c = arguments.length > 1,
                p = c ? i.originalEvent.dataTransfer.files : r.get(0).files,
                u = R(r.attr("multiple")),
                f = 0,
                v = 0,
            ...
            if (a.reader = null, a.resetUpload(), a.hideFileIcon(), a.isUploadable && a.$container.find(".file-drop-zone ." + a.dropZoneTitleClass).remove(), c)
                for (n = []; p[f];) s = p[f], s.type || s.size % 4096 !== 0 ? n.push(s) : v++, f++;
            else n = void 0 === i.target.files ? i.target && i.target.value ? [{
                name: i.target.value.replace(/^.+\\/, "")
            }] : [] : i.target.files; if (R(n) || 0 === n.length) return m || a.clear(), a.showFolderError(v), void a.raise("fileselectnone");
            if (a.resetErrors(), o = a.isUploadable ? a.getFileStack().length + n.length : n.length, a.maxFileCount > 0 && o > a.maxFileCount) return l = a.msgFilesTooMany.repl("{m}", a.maxFileCount).repl("{n}", o), a.isError = g(l, null, null, null), a.$captionContainer.find(".kv-caption-icon").hide(), a.setCaption("", !0), a.setEllipsis(), void a.$container.removeClass("file-input-new file-input-ajax-new");
            if (!m || u && h > 0) {
                ...
                u && h > 0 && (a.filestack = [])
            } else m && a.overwriteInitial && (a.clearPreview(), a.filestack = []);
            a.isPreviewable ? a.readFiles(n) : a.updateFileDetails(1), a.showFolderError(v)
        },
        autoSizeImage: function(e) {
            ...
            o.length && o.on("load", function() {
                i = l.width(), t = n.width(), i > t && (o.css("width", "100%"), l.css("width", "97%")), a = o.closest(".file-preview-frame").find(".file-caption-name"), a.length && (a.width(o.width()), a.attr("title", a.text())), r.raise("fileimageloaded", e), q.revokeObjectURL(o.attr("src"))
            })
        },
        ...
        setCaption: function(i, t) {
            ...
            if (t) a = e("<div>" + n.msgValidationError + "</div>").text(), r = '<span class="' + n.msgValidationErrorClass + '">' + n.msgValidationErrorIcon + a + "</span>";
                ...
                if (R(i) || 0 === n.$caption.length) return;
                a = e("<div>" + i + "</div>").text(), r = n.getLayoutTemplate("icon") + a
            }
            n.$caption.html(r), n.$caption.attr("title", a), n.$captionContainer.find(".file-caption-ellipsis").attr("title", a), n.setEllipsis()
        },
        ...
        if (r() || i(9)) {
            ...
            return a.shift(), this.each(function() {
                var i, r = e(this),
                    n = r.data("fileinput"),
                    l = "object" == typeof t && t,
                    o = l.language || r.data("language") || "en";
                n || (i = e.extend({}, e.fn.fileinput.defaults), "en" === o || R(e.fn.fileinputLocales[o]) || (i = e.extend(i, e.fn.fileinputLocales[o])), n = new H(this, e.extend(i, l, r.data())), r.data("fileinput", n)), "string" == typeof t && n[t].apply(n, a)
            })
        }
