    ...
    <div class="container">
        <div class="panel panel-default form-container">
            <div class="panel-body">
                ...
                <?php echo form_open("admin/home/reset_password", array('id' => 'loginForm', "role" => "form","novalidate"=>"novalidate"));?>    
                    <h3 class="text-center margin-xl-bottom">Forget Password!</h3>
                    ...
                    <div class="form-group text-center">
                        ...
                        <input name="cpassword" type="password" class="form-control input-lg" id="cpassword" placeholder="Confirm Password" required/>
                    </div>
