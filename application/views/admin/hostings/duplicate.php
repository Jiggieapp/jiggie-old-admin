        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                    ...
                    <div class="controls col-sm-4">
                        <select name="venue" class="form-control" required>
                            ...
                            <?php foreach($venues as $venue) { ?>
                                <option value="<?php echo $venue["id"];?>" <?php echo $hostings->venue_id == $venue["id"] ? "selected" : ""; ?>><?php echo $venue["name"];?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="controls col-sm-4">
                        <input name="theme" type="text" class="form-control" placeholder="Theme" value="<?php echo $hostings->theme; ?>" />
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" class="form-control autogrow" placeholder="Offering" rows="4" style="height: 105px;"><?php echo $hostings->description; ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="controls col-sm-4">
                        <input name="rank" type="text" class="form-control" placeholder="Rank" value="<?php echo $hostings->rank; ?>" />
