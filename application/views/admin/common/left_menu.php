    ...
    <ul class="nav nav-pills nav-stacked">
        ...
        <li class="nav-dropdown <?php echo strtolower($current_controller) =='user' ? 'active':''?>">
         ...
         <li class="nav-dropdown <?php echo strtolower($current_controller) =='hostings' ? 'active':''?>">
            <a href="<?php echo base_url() ?>admin/hostings/hosting/" title="Hostings">
         ...
         <li class="nav-dropdown <?php echo strtolower($current_controller) =='events' ? 'active':''?>">
            <a href="<?php echo base_url() ?>admin/events/" title="Events">
                <i class="fa fa-lg fa-fw fa-ticket"></i> Events
            </a>            
        </li>
         <li class="nav-dropdown <?php echo strtolower($current_controller) =='orders' ? 'active':''?>">
            <a href="<?php echo base_url() ?>admin/orders/" title="Orders">
                <i class="fa fa-lg fa-fw fa-shopping-cart"></i> Orders
            </a>            
        </li>
