...
<tbody >
	...
	if(!empty($chats)):
		foreach($chats as $chat):?>
			<tr data-backdrop="static" data-toggle="modal" data-target="#chatModal<?php echo $count;?>" class="" style='cursor: pointer' >
				<td>			 
	                 <?php echo date("m/d/Y H:i:s",strtotime(@$chat->last_updated))?> 
	                 <div class="modal fade modal<?php echo $count;?>" id="chatModal<?php echo $count;?>" tabindex="-1" role="dialog" aria-labelledby="chatModal<?php echo $count;?>" aria-hidden="true">
					  <div class="modal-dialog chat-box">
					    <div class="modal-content">
					      <div class="modal-header">
					        <button type="button" class="close" data-dismiss="modal<?php echo $count;?>"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
					      ...
					      <div class="modal-footer">
					        <button type="button" class="btn btn-default" data-dismiss="modal<?php echo $count;?>">Close</button>
				...
				<td>
					<?php echo date("m/d/Y H:i:s",strtotime(@$chat->topic_date))?></td>
				</td>			
				<td>
