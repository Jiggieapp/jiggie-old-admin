...
class CI_Pagination {
	...
	function create_links_ajax()
	{
		...
		if ($this->cur_page < $num_pages)
		{
			$output .= $this->next_tag_open.'<a href="javascript:void(null);" onclick="javascript:'.$this->callbackfunction.'(\''.$this->base_url.($this->cur_page * $this->per_page).'\');">'.$this->next_link.'</a>'.$this->next_tag_close;
		}
		...
		{
			$i = (($num_pages * $this->per_page) - $this->per_page);
			$output .= $this->last_tag_open.'<a href="javascript:void(null);" onclick="javascript:'.$this->callbackfunction.'(\''.$this->base_url.$i.'\');">'.$this->last_link.'</a>'.$this->last_tag_close;
		}
